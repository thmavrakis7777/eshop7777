  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-ink-muted">
        ...
        Κρήτης — το «Κόστος» και το «Δωρεάν άνω των» παραπάνω λειτουργούν κανονικά για αυτήν, με μία
        διαφορά: το «Δωρεάν άνω των» για αυτήν τη μέθοδο ισχύει για ολόκληρη την παραγγελία μόλις το
        υποσύνολο φτάσει το όριο, ακόμα και αν περιέχει ογκώδες/βαρύ προϊόν.
      </p>
