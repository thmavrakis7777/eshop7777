...
export async function saveProductAction(productId: string, formData: FormData): Promise<ActionResult> {
  ...
  try {
    await updateProduct(productId, {
      ...
      deliveryTextOverride: optionalText(formData.get("deliveryTextOverride")),
      returnsTextOverride: optionalText(formData.get("returnsTextOverride")),
      paymentTextOverride: optionalText(formData.get("paymentTextOverride")),
